      ...
      <S.LegalPersonForm onSubmit={handleSubmit(onFormSubmit)}>
        ...
        {!isChanging ? (
          <>
            ...
            <PhoneField name="phone" label="Телефон" rules={{ required: false }} />
            <TextField name="website" label="Сайт" rules={{ required: false }} />
            <EmailField name="email" label="Электронная почта" rules={{ required: false }} />
          </>
        ) : (
          <S.SkeletonGrid>
